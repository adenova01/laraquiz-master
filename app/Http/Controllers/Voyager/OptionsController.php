...
use App\Option;
use App\Qbank;
class OptionsController extends \TCG\Voyager\Http\Controllers\VoyagerBaseController
{
    ...
    {
        //dd($request->post()['correct_answer']);
        ...
        Option::where('id',$id)->update(['correct_answer'=>$correct_answer]);
